...
scripts/release-binaries.sh v1.1.0-rc.6
```
...
make release-binaries VERSION=v1.1.0-rc.6
```
...
```bash
curl -fsSL https://github.com/eclipse-iofog/edgelet/releases/download/v1.1.0-rc.6/install.sh -o install.sh
chmod +x install.sh
sudo ./install.sh --version=v1.1.0-rc.6
...
```bash
curl -fsSL https://github.com/Datasance/edgelet/releases/download/v1.1.0-rc.6/install.sh -o install.sh
chmod +x install.sh
sudo ./install.sh --version=v1.1.0-rc.6
```
