...
func (r *Router) setupRoutes() {
	...
	r.mux.HandleFunc("/v1/knowledge:pull", chainMiddleware(withRoute("/v1/knowledge:pull", r.apiHandler.HandleKnowledgePull), authMiddlewareV1, accessLoggingMiddleware, requestIDMiddleware))
	r.mux.HandleFunc("/v1/knowledge:pull/", chainMiddleware(withRoute("/v1/knowledge:pull/", r.apiHandler.HandleKnowledgePullStatus), authMiddlewareV1, accessLoggingMiddleware, requestIDMiddleware))
	r.mux.HandleFunc("/v1/knowledge:prune", chainMiddleware(withRoute("/v1/knowledge:prune", r.apiHandler.HandleKnowledgePrune), authMiddlewareV1, accessLoggingMiddleware, requestIDMiddleware))
	r.mux.HandleFunc("/v1/knowledge", chainMiddleware(withRoute("/v1/knowledge", r.apiHandler.HandleKnowledge), authMiddlewareV1, accessLoggingMiddleware, requestIDMiddleware))
	r.mux.HandleFunc("/v1/knowledge/", chainMiddleware(withRoute("/v1/knowledge/", r.apiHandler.HandleKnowledge), authMiddlewareV1, accessLoggingMiddleware, requestIDMiddleware))
	...
	r.mux.HandleFunc("/v1/deploy/knowledge:apply", chainMiddleware(withRoute("/v1/deploy/knowledge:apply", r.apiHandler.HandleDeployKnowledgeApply), authMiddlewareV1, accessLoggingMiddleware, requestIDMiddleware))
	r.mux.HandleFunc("/v1/deploy/knowledge:validate", chainMiddleware(withRoute("/v1/deploy/knowledge:validate", r.apiHandler.HandleDeployKnowledgeValidate), authMiddlewareV1, accessLoggingMiddleware, requestIDMiddleware))
